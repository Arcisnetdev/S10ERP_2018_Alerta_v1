...
namespace S10ERP_2018.Frontend_Alerta_Pedido_Sin_Atender
{
    public partial class Frm_Pedido_Sin_Atender : Form
    {
        public Frm_Pedido_Sin_Atender()
        {
            InitializeComponent();
        }

        private void Frm_Pedido_Sin_Atender_Load(object sender, EventArgs e)
        {
            BE_Pedido_Sin_Atenders controls = (BE_Pedido_Sin_Atenders)BL_ObjCOntrol_Pedido_Sin_Atender.PoblarPedido_Sin_AtenderSelAll();
        ...
        {
            DateTime DateEnd = Convert.ToDateTime("15/04/2018").Date;
            ...
            //message.From = new MailAddress("alerta@qlabsp.com", "Pedidos de Compra Aprobados, pendientes de Atender.", Encoding.UTF8);
            message.From = new MailAddress("alerta@qlabsp.com", diaRes + "Pedidos de Compra Aprobados, pendientes de Atender.", Encoding.UTF8);
            //message.From = new MailAddress("noresponder@nexcom.com.pe", "Pedidos de Compra Aprobados, pendientes de Atender.", Encoding.UTF8);
        ...
        private string TextoEnvioAlertaPedidoSinAprobar()
        {
            ...
            try
            {
                enumerator = ((IEnumerable)BL_ObjCOntrol_Pedido_Sin_Atender.PoblarPedido_Sin_AtenderSelAll()).GetEnumerator();
                while (enumerator.MoveNext())
                {
                    BE_Pedido_Sin_Atender current = (BE_Pedido_Sin_Atender)enumerator.Current;
