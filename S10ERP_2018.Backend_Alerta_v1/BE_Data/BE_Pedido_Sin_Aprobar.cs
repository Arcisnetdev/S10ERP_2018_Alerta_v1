...
{
   public class BE_Pedido_Sin_Aprobar
    {
        ...
        public BE_Pedido_Sin_Aprobar()
        { }

        public BE_Pedido_Sin_Aprobar(string tcProyecto, string tcAlmacen, string tcNroPedido, string tcEstado ,string tcFechaPedido, string tcCreacionFecha, string tcActualizacionFecha,
